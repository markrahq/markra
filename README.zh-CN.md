...
<p align="center">
  <a href="README.md">English</a> | 简体中文 | <a href="https://editor.markra.app/">Web 编辑器</a> | <a href="#下载">下载</a> | <a href="#核心特性">核心特性</a> | <a href="#参与贡献">参与贡献</a> | <a href="#贡献者">贡献者</a> | <a href="#许可证">许可证</a>
</p>
...
- 打开单个文件或整个文件夹，在文件树中浏览、新建、重命名、移动、删除、排序和定位文件。
...
<p align="center">
  <a href="https://github.com/murongg/markra/graphs/contributors">
    <img src="https://contrib.rocks/image?repo=murongg/markra" alt="Markra 贡献者" />
  </a>
</p>
